...
public class ConstantsUtils {
	...
	public static final String CONSUMER_KEY = "UnWcjSGaKLsofmQuIB53T97bC";
	public static final String CONSUMER_SECRET ="YY3Rf2PUb8aFuN3Dwhfdm7ggN7SQ2Rsu9gaY8wpZhtt9AUvsh6";
